...
const T = {
  en: {
    ...
    subtitle: 'Enter your email and order number from your order receipt to access your filing status.',
    email: 'Email address',
  ...
  es: {
    ...
    error: 'No encontramos una orden con ese correo y número de orden.',
    portal: 'Portal de Clientes',
  },
}

function LoginForm({ initialIsFBFC }: { initialIsFBFC: boolean }) {
  ...
  // Separación de dominios (2026-08-13): el host ya se resolvió server-side
  // en page.tsx (evita el parpadeo de marca por defecto que tendría detectar
  // esto en un useEffect, mismo criterio que initialLang en el dashboard).
  const isFBFC = initialIsFBFC
      ...
      <div className="portal-wrapper">
        ...
        <div className="portal-header">
          <div className="portal-header-brand">
            {isFBFC ? (
              <img src="/fbfc-seal.png" alt="Florida Business Formation Center" style={{ width: 48, height: 48, borderRadius: 14 }} />
            ) : (
              <div className="portal-header-icon">🏛️</div>
            )}
            <div className="portal-header-name">
              {isFBFC ? (
                <span style={{ fontFamily: 'var(--font-serif)', fontWeight: 700, fontSize: '1.15rem' }}>Florida Business Formation Center</span>
              ) : (
                <>
        ...
        <div className="card">
          ...
          <div className="card-form">
                ...
                <div className="contact-note" ref={contactRef}>
                  ...
                  {showContact && (
                    <div className="contact-options">
                      <a className="contact-option" href={`mailto:info@${isFBFC ? 'mybusinessformation.com' : 'opabiz.com'}`}>
            ...
            <p className="copyright">© 2026 Florida Business Formation Center — {isFBFC ? 'mybusinessformation.com' : 'opabiz.com'}</p>
...
export default function ClientPortalLoginForm({ initialIsFBFC }: { initialIsFBFC: boolean }) {
  return (
    <Suspense fallback={null}>
      <LoginForm initialIsFBFC={initialIsFBFC} />
    </Suspense>
  )
}
