...
const T = {
  en: {
    ...
    accounting: 'Accounting', security: 'Security', drafts: 'OrderDraft', opabiz: 'OPABIZ', logout: 'Log out',
  ...
  es: {
    ...
    accounting: 'Contabilidad', security: 'Seguridad', drafts: 'OrderDraft', opabiz: 'OPABIZ', logout: 'Cerrar sesión',
