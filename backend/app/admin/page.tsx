...
const T = {
  en: {
    ...
    accounting: 'Accounting', security: 'Security', drafts: 'OrderDraft', opabiz: 'OpaBiz Connect', guias: 'Guides', afiliados: 'Affiliates', logout: 'Log out',
  ...
  es: {
    ...
    accounting: 'Contabilidad', security: 'Seguridad', drafts: 'OrderDraft', opabiz: 'OpaBiz Connect', guias: 'Guías', afiliados: 'Afiliados', logout: 'Cerrar sesión',
      ...
      <div className="admin-wrapper">
        <div className="admin-header">
          ...
          <div style={{ display: 'flex', gap: '10px', alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <a href="/admin/afiliados" style={{ fontSize: '13px', color: '#6b7280', textDecoration: 'none', padding: '7px 14px', border: '1.5px solid #e5e7eb', borderRadius: '8px', fontWeight: 600 }}>
              {t.afiliados}
            </a>
