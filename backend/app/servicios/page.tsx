...
export default function ServiciosPage() {
  ...
  const services: Service[] = [
    ...
    { id: 'amendment', icon: 'pencil', name: 'Articles of Amendment', name_es: 'Artículos de Enmienda', price: '$59', stateFee: 25,
      ...
      time_en: '&#9889; Processing: approximately 5–10 days after submission',
      time_es: '&#9889; Procesamiento: 5-10 días aproximados después del envío',
    ...
    { id: 'foreign-llc', icon: 'globe-2', name: 'Foreign LLC / Corp Registration', name_es: 'Registro de LLC / Corp Extranjera', price: '$99',
      ...
      includes_en: ['Foreign qualification filing in target state','Certificate of Authority from FL Division of Corps','Available for all 50 U.S. states'],
      includes_es: ['Calificación como Entidad Extranjera en el estado destino','Certificado de Autoridad de la División de Corporaciones FL','Disponible para los 50 estados de USA'],
      time_en: '&#9889; Processing: approximately 5–10 days',
      time_es: '&#9889; Procesamiento: 5-10 días aproximados',
  ...
  const servicesAccordionHtml = services.map(s => `
    <div class="svc-acc-item" data-svc="${s.id}" id="${s.id}" onclick="touchSvc(this)">
      <div class="svc-acc-header">
        ...
        <button class="svc-add-btn svc-acc-add" data-svc="${s.id}" onclick="event.stopPropagation();closeSvcPopup(this);toggleCart('${s.id}')"><span class="svc-add-lbl">Agregar al pedido</span></button>
