...
<section class="bundle-section">
  <div class="bundle-inner">
    ...
    <div class="bundle-btns">
      ...
      <button id="bundle-btn-sec" class="btn-bundle-sec" onclick="window.open('https://cal.com/businessformation/consultation','_blank')">&#128197; Schedule a Consultation</button>
    </div>
  </div>
</section>
...
function setLang(lang){
  ...
  e=document.getElementById('bundle-btn-sec');  if(e){ e.innerHTML=isEs?'&#128197; Programar cita de consulta':'&#128197; Schedule a Consultation'; e.setAttribute('onclick',"window.open('"+(isEs?'https://cal.com/businessformation/consulta-gratuita-formacion-de-negocios-30-min':'https://cal.com/businessformation/consultation')+"','_blank')"); }
