...
<section class="bundle-section">
  <div class="bundle-inner">
    ...
    <div class="bundle-btns">
      ...
      <button id="bundle-btn-sec" class="btn-bundle-sec" onclick="window.open('/booking','_self')">&#128197; Schedule a Consultation</button>
    </div>
  </div>
</section>
...
function setLang(lang){
  ...
  e=document.getElementById('bundle-btn-sec');  if(e){ e.innerHTML=isEs?'&#128197; Programar cita de consulta':'&#128197; Schedule a Consultation'; e.setAttribute('onclick',"window.open('"+(isEs?'/booking?lang=es':'/booking')+"','_self')"); }
