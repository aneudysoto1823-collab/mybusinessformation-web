...
export default function ServiciosPage() {
  ...
  const services: Service[] = [
    ...
    { id: 'registered-agent', icon: 'home', name: 'Registered Agent', name_es: 'Agente Registrado', price: '$99',
      ...
      includes_en: ['Official FL street address for your business','Accepts service of process &amp; legal documents','Change of Registered Agent filed with state','Document forwarding &amp; email notifications','&#127881; Add any other service and your first year is FREE'],
      includes_es: ['Dirección oficial en FL para tu negocio','Acepta notificaciones y documentos legales','Cambio de Agente Registrado tramitado ante el estado','Reenvío de documentos y notificación por correo','&#127881; Agrega cualquier otro servicio y tu primer año es GRATIS'],
