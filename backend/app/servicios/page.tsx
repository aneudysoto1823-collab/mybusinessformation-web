...
'registered-agent':{
  ...
  html:\`
    ...
    <div class="form-group"><label class="form-label">Florida Document Number (del estado)</label><input type="text" class="form-input" placeholder="e.g. L23000123456" onblur="lookupFLDoc(this)"/><div id="fldoc-status" style="margin-top:5px;min-height:18px"></div></div>
...
'ein':{
  ...
  html:\`
    ...
    <div class="form-group"><label class="form-label">Florida Document Number (del estado)</label><input type="text" class="form-input" placeholder="Optional — helps confirm entity" onblur="lookupFLDoc(this)"/><div id="fldoc-status" style="margin-top:5px;min-height:18px"></div></div>
    <div class="section-divider">Business Information</div>
...
'dba':{
  ...
  html:\`
    ...
    <div class="form-group"><label class="form-label">Florida Document Number (del estado)</label><input type="text" class="form-input" placeholder="e.g. L23000123456 (if entity is registered)" onblur="lookupFLDoc(this)"/><div id="fldoc-status" style="margin-top:5px;min-height:18px"></div></div>
    <div class="section-divider">Business Information</div>
...
'annual-report':{
  ...
  html:\`
    ...
    <div class="form-group"><label class="form-label">Florida Document Number *</label><input type="text" class="form-input" placeholder="e.g. L23000123456 — from your state records" onblur="lookupFLDoc(this)"/><div id="fldoc-status" style="margin-top:5px;min-height:18px"></div></div>
    <div class="section-divider">Business Information</div>
    <div class="form-group"><label class="form-label">Entity Type *</label><select class="select-input" data-field="entity-type"><option value="">Select...</option><option>LLC</option><option>Corporation</option></select></div>
...
'amendment':{
  ...
  html:\`
    ...
    <div class="form-group"><label class="form-label">Florida Document Number *</label><input type="text" class="form-input" placeholder="e.g. L23000123456 — from your state certificate" onblur="lookupFLDoc(this)"/><div id="fldoc-status" style="margin-top:5px;min-height:18px"></div></div>
...
'cierre-fiscal':{
  ...
  html:\`
    ...
    <div class="form-group"><label class="form-label">Florida Document Number (del estado)</label><input type="text" class="form-input" placeholder="e.g. L23000123456 (if entity was registered in FL)"/></div>
...
function setLang(lang){
  ...
  e=document.getElementById('bundle-btn-sec');  if(e)e.innerHTML=isEs?'&#128197; Programar cita de consulta':'&#128197; Schedule a Consultation';
  ...
  var fd=document.querySelector('.footer-disclaimer'); if(fd)fd.innerHTML=isEs?'<strong style="color:rgba(255,255,255,0.5);display:block;margin-bottom:4px">Aviso Importante</strong> Florida Business Formation Center es un servicio profesional de preparación y presentación de documentos. No somos una firma de abogados y no brindamos asesoría legal, fiscal ni financiera. Nuestros servicios no constituyen el ejercicio del derecho ni crean una relación abogado-cliente. Todos los trámites están sujetos a aprobación por la División de Corporaciones de Florida y el IRS. Para orientación legal o fiscal específica a su situación, le recomendamos consultar con un abogado licenciado en Florida o un contador público certificado.':'<strong style="color:rgba(255,255,255,0.5);display:block;margin-bottom:4px">Important Notice</strong>Florida Business Formation Center is a professional document preparation and filing service. We are not a law firm and do not provide legal, tax, or financial advice. Our services do not constitute the practice of law and do not create an attorney-client relationship. All filings are subject to approval by the Florida Division of Corporations and the IRS. For legal or tax guidance specific to your situation, we encourage you to consult a licensed Florida attorney or certified public accountant.';
