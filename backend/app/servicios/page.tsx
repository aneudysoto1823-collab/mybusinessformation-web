...
const SERVICIOS_FOR_SCHEMA: SchemaService[] = [
  ...
  { id: 'business-tax-receipt', name: 'Local Business Tax Receipt', description: 'Local business tax receipt (occupational license) required by most Florida counties and municipalities to operate.', priceUsd: 99 },
  ...
  { id: 'certified-copy', name: 'Certified Copy of Articles of Organization / Incorporation', description: 'State-certified copy of your Florida formation document, stamped by the Division of Corporations.', priceUsd: 59 },
]
...
export default function ServiciosPage() {
  ...
  const services: Service[] = [
    ...
    { id: 'registered-agent', icon: 'home', name: 'Registered Agent', name_es: 'Agente Registrado', price: '$99',
      sub_en: 'Free 1st year with any other service · $99/yr', sub_es: 'Gratis 1er año con cualquier otro servicio · $99/año',
      ...
      includes_en: ['Official FL street address for state &amp; legal correspondence','Accepts service of process &amp; legal documents','Document forwarding &amp; email notifications','&#127881; Add any other service and your first year is FREE'],
      includes_es: ['Dirección oficial en FL para correspondencia legal y estatal','Acepta notificaciones y documentos legales','Reenvío de documentos y notificación por correo','&#127881; Agrega cualquier otro servicio y tu primer año es GRATIS'],
    ...
    { id: 'business-tax-receipt', icon: 'receipt', name: 'Local Business Tax Receipt', name_es: 'Licencia Comercial Local', price: '$99',
      ...
      time_en: '&#9889; Processing: 3–7 business days',
      time_es: '&#9889; Procesamiento: 3-7 días hábiles',
      btn_en: 'Order Local Business Tax Receipt — $99 &#8594;', btn_es: 'Ordenar Licencia Comercial Local — $99 &#8594;' },
    { id: 'sales-tax-registration', icon: 'trending-up', name: 'Sales Tax Registration', name_es: 'Registro de Impuesto sobre Ventas', price: '$99',
      ...
      includes_en: ['FL Department of Revenue registration','Sales tax certificate (DR-11)','Required for businesses selling taxable goods'],
      includes_es: ['Registro con el Departamento de Ingresos de FL','Certificado de impuesto sobre ventas (DR-11)','Requerido para negocios que venden bienes gravables'],
      time_en: '&#9889; Processing: 2–5 business days',
      time_es: '&#9889; Procesamiento: 2-5 días hábiles',
    ...
    { id: 'good-standing', icon: 'award', name: 'Certificate of Good Standing', name_es: 'Certificado de Buena Reputación', price: '$49', stateFee: 9,
      ...
      includes_en: ['Official certificate from FL Division of Corps','Certified digital &amp; physical copy','Accepted by banks, investors &amp; agencies'],
      includes_es: ['Certificado oficial de la División de Corporaciones FL','Copia digital y física certificada','Aceptado por bancos, inversionistas y agencias'],
    ...
    { id: 'scorp-election', icon: 'star', name: 'S-Corp Election (Form 2553)', name_es: 'Elección de S-Corp (Formulario 2553)', price: '$79',
      ...
      includes_en: ['IRS Form 2553 preparation &amp; submission','IRS acceptance confirmation letter','Only for U.S. citizens &amp; permanent residents'],
      includes_es: ['Preparación y envío del Formulario 2553 del IRS','Carta de aceptación del IRS','Solo para ciudadanos y residentes permanentes de USA'],
    ...
    { id: 'foreign-llc', icon: 'globe-2', name: 'Foreign LLC / Corp Registration', name_es: 'Registro de LLC / Corp Extranjera', price: '$99',
      ...
      includes_en: ['Foreign qualification filing in target state','Certificate of Authority from FL Division of Corps','Registered Agent in target state available as an add-on','Available for all 50 U.S. states'],
      includes_es: ['Calificación como Entidad Extranjera en el estado destino','Certificado de Autoridad de la División de Corporaciones FL','Agente Registrado en el estado destino disponible como adicional','Disponible para los 50 estados de USA'],
    ...
    { id: 'cierre-fiscal', icon: 'lock', name: 'Tax Account Closure', name_es: 'Cierre de Cuentas Fiscales', price: '$79',
      ...
      includes_en: ['IRS EIN account closure letter preparation','FL Department of Revenue account closure','Verification your accounts are properly closed','Confirmation documents delivered by email'],
      includes_es: ['Preparación de carta de cierre de cuenta EIN con el IRS','Cierre de cuenta con el Departamento de Ingresos de FL','Verificación de que tus cuentas quedan correctamente cerradas','Documentos de confirmación entregados por correo'],
      time_en: '&#9889; Processing: 5–10 business days',
      time_es: '&#9889; Procesamiento: 5-10 días hábiles',
    ...
    { id: 'certified-copy', icon: 'file-text', name: 'Certified Copy of Articles', name_es: 'Copia Certificada de Artículos', price: '$59', stateFee: 30,
      ...
      includes_es: ['Copia certificada por la División de Corporaciones de FL','Para LLC (Organización) o Corporación (Incorporación)','Aceptada por bancos, tribunales y agencias','Opciones de entrega digital y física'],
      time_en: '&#9889; Processing: 2-5 business days',
      time_es: '&#9889; Procesamiento: 2-5 días hábiles',
      btn_en: 'Order Certified Copy — $59 &#8594;', btn_es: 'Ordenar Copia Certificada — $59 &#8594;' },
    { id: 'stripe-setup-guide', icon: 'book-open', name: 'Stripe Setup Guide', name_es: 'Guía Setup Stripe', price: 'Coming soon',
      sub_en: 'Coming soon', sub_es: 'Próximamente',
      desc_en: 'Coming soon. Contact us for details.',
      desc_es: 'Próximamente. Contáctanos para más detalles.',
      includes_en: [],
      includes_es: [],
      time_en: '',
      time_es: '',
      btn_en: 'Coming soon', btn_es: 'Próximamente' }
  ]
...
/* PAGE HERO */
.page-hero{background:#fff;border-bottom:1px solid var(--gray200);padding:30px 32px 26px;text-align:center}
.page-hero-inner{max-width:700px;margin:0 auto;position:relative;z-index:1}
.hero-badge{display:inline-block;background:var(--blue-light);border:1px solid #dbeafe;color:var(--blue);font-size:.7rem;font-weight:700;padding:5px 14px;border-radius:20px;letter-spacing:1px;text-transform:uppercase;margin-bottom:12px}
.page-hero h1{font-size:clamp(1.7rem,4vw,2.4rem);color:var(--navy);font-weight:700;margin-bottom:0;letter-spacing:0}
.page-hero h1 em{color:var(--blue);font-style:normal}
.page-hero p{font-size:.95rem;color:var(--gray500);line-height:1.6;margin:8px 0 0}
...
/* BUNDLE BANNER */
.bundle-section{background:#fff;border-top:1px solid var(--gray200);padding:48px 32px;text-align:center;color:var(--gray800)}
...
'operating-agreement':{
  ...
  price:'$79',
  html:\`
    <div class="info-box"><strong>Florida State Requirement:</strong> Banks require your Operating Agreement (along with your EIN and Articles of Organization / Incorporation) to open a business checking account.</div>
...
'virtual-address':{
  title:'Virtual Mailing Address — $30/month',
  title_es:'Dirección Postal Virtual — $30/mes',
  ...
  html:\`
    ...
    <div class="form-group"><label class="form-label">Plan</label><select class="select-input"><option>Digital Forwarding Only — $30/month</option><option>Digital + Physical Forwarding — $40/month</option></select></div>
    ...
    <div class="summary-box"><div class="summary-row"><span>Virtual Mailing Address</span><span>$30/month</span></div><div class="summary-row"><span>Setup Fee</span><span>FREE</span></div><div class="summary-row"><span style="font-weight:700">First Month Due Today</span><span>$30</span></div></div>
    <button class="btn-submit-svc" onclick="submitService()">Activate Virtual Address — $30 &#8594;</button>
...
'banking-resolution':{
  ...
  price:'$49',
  html:\`
    <div class="info-box"><strong>Required by most banks:</strong> A Banking Resolution authorizes your LLC or Corporation to open a business bank account. Most U.S. banks require this document along with your EIN and Articles of Organization / Incorporation.</div>
    <div class="form-group"><label class="form-label">Número de Registro Estatal</label><input type="text" class="form-input" placeholder="e.g. L23000123456" onblur="lookupFLDoc(this)"/><div id="fldoc-status" style="margin-top:5px;min-height:18px"></div></div>
    <div class="section-divider">Business Information</div>
    <div class="form-group"><label class="form-label">Entity Type *</label><select class="select-input" data-field="entity-type"><option value="">Select...</option><option>LLC</option><option>Corporation</option></select></div>
...
'business-tax-receipt':{
  title:'Local Business Tax Receipt — $99',
  title_es:'Licencia Comercial Local — $99',
  ...
  html:\`
    ...
    <button class="btn-submit-svc" onclick="submitService()">Order Local Business Tax Receipt — $99 &#8594;</button>
...
'foreign-llc':{
  ...
  html:\`
    ...
    <div class="form-group"><label class="form-label">Phone / WhatsApp</label><input type="tel" class="form-input" placeholder="(XXX) XXX-XXXX"/></div>
    <div class="form-group"><label class="form-label">Electronic Signature *</label><input type="text" class="form-input" placeholder="Type full legal name"/></div>
    <div class="summary-box"><div class="summary-row"><span>Foreign Registration Service Fee</span><span>$99</span></div><div class="summary-row"><span>State Filing Fee</span><span>Varies by state</span></div><div class="summary-row"><span style="font-weight:700">Service Fee Due Today</span><span>$99</span></div></div>
    <button class="btn-submit-svc" onclick="submitService()">Order Foreign Registration — $99 &#8594;</button>
    <div class="disclaimer">State filing fees vary by state and are paid separately. Registered Agent service in the target state is available as an add-on — contact us for pricing.</div>\`
},
'business-license':{
...
'certified-copy':{
  title:'Certified Copy of Articles — $59',
  title_es:'Copia Certificada de Artículos — $59',
  sub:'An official state-certified copy of your Articles of Organization or Incorporation, stamped by the Florida Division of Corporations.',
  sub_es:'Una copia oficial certificada por el estado de tus Artículos de Organización o Incorporación, sellada por la División de Corporaciones de Florida.',
  price:'$59 + state fee',
  html:\`
    <div class="info-box"><strong>When do you need this?</strong> Banks, courts, and government agencies often require an official certified copy of your formation document, not a plain copy. We order it directly from the Florida Division of Corporations.</div>
    <div class="form-group"><label class="form-label">Número de Registro Estatal *</label><input type="text" class="form-input" placeholder="e.g. L23000123456" onblur="lookupFLDoc(this)"/><div id="fldoc-status" style="margin-top:5px;min-height:18px"></div></div>
    <div class="section-divider">Business Information</div>
    <div class="form-group"><label class="form-label">Entity Type *</label><select class="select-input" data-field="entity-type"><option value="">Select...</option><option>LLC</option><option>Corporation</option></select></div>
    <div class="form-group"><label class="form-label">Registered Business Name *</label><input type="text" class="form-input" data-field="business-name" placeholder="Exact name as registered with State of Florida"/></div>
    <div class="section-divider">Copy Details</div>
    <div class="form-group"><label class="form-label">Number of Certified Copies *</label><select class="select-input"><option>1 copy</option><option>2 copies</option><option>3 copies</option><option>5 copies</option></select></div>
    <div class="form-group"><label class="form-label">Delivery Format *</label><select class="select-input"><option>Digital (PDF) — faster</option><option>Physical copy by mail</option><option>Both digital and physical</option></select></div>
    <div class="section-divider">Contact</div>
    <div class="form-group"><label class="form-label">Email *</label><input type="email" class="form-input" placeholder="you@email.com"/></div>
    <div class="form-group"><label class="form-label">Phone / WhatsApp</label><input type="tel" class="form-input" placeholder="(XXX) XXX-XXXX"/></div>
    <div class="form-group"><label class="form-label">Electronic Signature *</label><input type="text" class="form-input" placeholder="Type full legal name"/></div>
    <div class="summary-box"><div class="summary-row"><span>Certified Copy Service</span><span>$59</span></div><div class="summary-row"><span>FL Division of Corporations Fee</span><span>State fee</span></div><div class="summary-row"><span style="font-weight:700">Total Today</span><span>$59 + state fee</span></div></div>
    <button class="btn-submit-svc" onclick="submitService()">Order Certified Copy — $59 &#8594;</button>
    <div class="disclaimer">The certified copy is issued by the Florida Division of Corporations. The state fee is separate and varies by document type.</div>\`
}
};
...
function setLang(lang){
  ...
  var prM={'registered-agent':isEs?'<strong>$99</strong> &nbsp;&middot;&nbsp; Requerido por ley en FL':'<strong>$99</strong> &nbsp;&middot;&nbsp; Required by FL law','ein':isEs?'<strong>$99</strong> &nbsp;&middot;&nbsp; Pago único':'<strong>$99</strong> &nbsp;&middot;&nbsp; One-time fee','operating-agreement':isEs?'<strong>$79</strong> &nbsp;&middot;&nbsp; Pago único':'<strong>$79</strong> &nbsp;&middot;&nbsp; One-time fee','itin':isEs?'<strong>$135</strong> &nbsp;&middot;&nbsp; Pago único':'<strong>$135</strong> &nbsp;&middot;&nbsp; One-time fee','dba':isEs?'<strong>$49 + tarifa estatal FL</strong>':'<strong>$49 + FL state fee</strong>','virtual-address':isEs?'<strong>$30</strong> &nbsp;&middot;&nbsp; Cancela cuando quieras':'<strong>$30</strong> &nbsp;&middot;&nbsp; Cancel anytime','annual-report':isEs?'<strong>$99</strong> &nbsp;&middot;&nbsp; Fecha Límite FL: 1 de mayo':'<strong>$99</strong> &nbsp;&middot;&nbsp; FL Deadline: May 1','amendment':isEs?'<strong>$59 + tarifa estatal FL</strong>':'<strong>$59 + FL state fee</strong>'};
