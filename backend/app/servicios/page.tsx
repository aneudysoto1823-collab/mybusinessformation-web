...
export default function ServiciosPage() {
  ...
  const services: Service[] = [
    ...
    { id: 'virtual-address', icon: 'map-pin', name: 'Virtual Mailing Address', name_es: 'Dirección Virtual de Correo', price: '$99',
      sub_en: 'Billed monthly · cancel anytime', sub_es: 'Cobro mensual · cancela cuando quieras',
      ...
      btn_en: 'Order Virtual Address — $99/mo &#8594;', btn_es: 'Ordenar Dirección Virtual — $99/mes &#8594;' },
    { id: 'annual-report', icon: 'calendar', name: 'Annual Report Filing', name_es: 'Presentación de Reporte Anual', price: '$99',
      sub_en: 'Billed annually · renews until cancelled', sub_es: 'Cobro anual · se renueva hasta cancelar',
