  ...
  <div class="section-inner">
    <div class="help-bar">
      ...
      <div class="help-btns">
        ...
        <button id="hero-cal-btn" class="btn-cal" onclick="window.open('/booking','_self')">
...
function setLang(lang) {
  ...
  el=document.getElementById('hero-cal-btn'); if(el){ el.innerHTML = isEs ? '&#128197; Programar Consulta Gratuita &rarr;' : '&#128197; Schedule Free Consultation &rarr;'; el.setAttribute('onclick',"window.open('"+(isEs?'/booking?lang=es':'/booking')+"','_self')"); }
