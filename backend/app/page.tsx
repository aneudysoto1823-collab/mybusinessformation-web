...
'tt-ein':isEs?'El EIN es como el n\\u00famero de seguro social de tu negocio. El IRS lo exige para abrir una cuenta bancaria empresarial, contratar empleados y declarar impuestos. La mayor\\u00eda de los bancos no te dejar\\u00e1n abrir una cuenta de negocios sin uno. Diferencia: el EIN identifica a tu negocio, mientras que el ITIN te identifica a ti como persona sin N\\u00famero de Seguro Social de EE.UU. No son lo mismo, y muchos due\\u00f1os extranjeros necesitan ambos.':'An EIN is like a Social Security Number for your business. The IRS requires it to open a business bank account, hire employees, and file taxes. Most banks won\\'t let you open a business account without one. Difference: an EIN identifies your business, while an ITIN identifies you as a person without a U.S. Social Security Number. They are not the same, and many foreign owners need both.',
