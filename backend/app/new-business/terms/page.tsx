...
<div class="page-layout">
  ...
  <div class="doc-content">
    ...
    <div class="doc-section" id="fees">
      ...
      <p class="en">By purchasing a recurring service you authorize Florida Business Formation Center to charge your payment method automatically at the start of each billing cycle, at the then-current rate, until you cancel. You may cancel at any time from your client account, or by contacting <!--email_off--><a href="mailto:info@mybusinessformation.com">info@mybusinessformation.com</a><!--/email_off-->, before the next renewal date; cancellation stops future charges but does not refund fees already billed for the current cycle. We may change recurring fees with reasonable advance notice, which will apply to subsequent billing cycles.</p>
      <p class="es" style="display:none">Al comprar un servicio recurrente autorizas a Florida Business Formation Center a cobrar tu m&eacute;todo de pago autom&aacute;ticamente al inicio de cada ciclo de cobro, a la tarifa vigente, hasta que canceles. Puedes cancelar en cualquier momento desde tu cuenta de cliente, o escribiendo a <!--email_off--><a href="mailto:info@mybusinessformation.com">info@mybusinessformation.com</a><!--/email_off-->, antes de la siguiente fecha de renovaci&oacute;n; la cancelaci&oacute;n detiene los cobros futuros pero no reembolsa las tarifas ya cobradas del ciclo en curso. Podemos modificar las tarifas recurrentes con un aviso anticipado razonable, que aplicar&aacute; a los ciclos de cobro siguientes.</p>
      <h3 class="en">4.3 Processing Times &amp; Service Fee Refunds</h3><h3 class="es" style="display:none">4.3 Tiempos de Procesamiento y Reembolsos de Tarifas de Servicio</h3>
      <p class="en">Processing times shown on our site are estimates only and are not guaranteed (for example, EIN filings typically take 1&ndash;3 business days via the IRS). These timeframes depend on the current processing volume of the Internal Revenue Service, the State of Florida, or other government agencies involved, and are beyond our control.</p>
      <p class="es" style="display:none">Los tiempos de procesamiento que se muestran en nuestro sitio son estimados solamente y no est&aacute;n garantizados (por ejemplo, los tr&aacute;mites de EIN suelen tardar entre 1 y 3 d&iacute;as h&aacute;biles a trav&eacute;s del IRS). Estos plazos dependen del volumen de procesamiento actual del Servicio de Impuestos Internos (IRS), el Estado de Florida u otras agencias gubernamentales involucradas, y est&aacute;n fuera de nuestro control.</p>
      <p class="en">If your order takes longer than the estimated timeframe, please note that once we have submitted your filing or request to the applicable government agency, our service fee is non-refundable, because our portion of the work has already been completed. The estimated timeframe reflects that agency&rsquo;s typical turnaround, not ours.</p>
      <p class="es" style="display:none">Si su pedido tarda m&aacute;s del plazo estimado, tenga en cuenta que una vez que hayamos presentado su tr&aacute;mite o solicitud ante la agencia gubernamental correspondiente, nuestra tarifa de servicio no es reembolsable, ya que nuestra parte del trabajo ya fue completada. El plazo estimado refleja el tiempo t&iacute;pico de respuesta de esa agencia, no el nuestro.</p>
      <h3 class="en">4.4 Service Fees vs. Government Fees</h3><h3 class="es" style="display:none">4.4 Honorarios de Servicio</h3>
      <p class="en">The fees we charge correspond exclusively to our document preparation and filing services (including EIN, Annual Report, and Registered Agent, among others). We are not a government agency, we are not affiliated with the State of Florida, the IRS, or any government entity, and you are not required to hire our services.</p>
      <p class="es" style="display:none">Los honorarios que cobramos corresponden exclusivamente a nuestros servicios de preparaci&oacute;n y presentaci&oacute;n de documentos (incluyendo EIN, Declaraci&oacute;n Anual y Agente Registrado, entre otros). No somos una agencia gubernamental, no estamos afiliados con el Estado de Florida, el IRS, ni con ninguna entidad de gobierno, y usted no est&aacute; obligado a contratar nuestros servicios.</p>
    </div>
