...
export const metadata: Metadata = {
  title: 'Affiliate & Agent Program | Florida Business Formation Center',
  description:
    'Partner with Florida Business Formation Center: refer clients with your own coupon code, or join our team as a field agent and earn commission on every order you assist.',
...
<div class="af-page">
  <div class="af-card" id="af-card">
    ...
    <h1 class="en">Partner with us.</h1>
    <h1 class="es" style="display:none">Sea socio de nuestro equipo.</h1>
...
async function afSubmit(ev){
  ...
  try {
    var res = await fetch('/api/affiliates/apply', {
      ...
      body: JSON.stringify({ name: name, email: email, phone: phone, ptin: afMode==='affiliate' ? ptin : undefined, type: afMode, brand: 'fbfc', lang: isEs ? 'es' : 'en' })
    });
