...
const DISPLAY: Record<string, Display> = {
  'registered-agent': { icon: 'home', subEn: 'Free 1st year with any other service · $99/yr', subEs: 'Gratis 1er año con cualquier otro servicio · $99/año',
    ...
    incEn: ['Official FL street address for your business', 'Accepts service of process & legal documents', 'Document forwarding & email notifications'],
    incEs: ['Dirección oficial en FL para tu negocio', 'Acepta notificaciones y documentos legales', 'Reenvío de documentos y notificación por correo'] },
