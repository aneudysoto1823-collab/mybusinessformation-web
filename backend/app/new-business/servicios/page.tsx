...
const DISPLAY: Record<string, Display> = {
  'registered-agent': { icon: 'home', subEn: 'Free 1st year with any other service · $99/yr', subEs: 'Gratis 1er año con cualquier otro servicio · $99/año',
    ...
    incEn: ['Official FL street address for state & legal correspondence', 'Accepts service of process & legal documents', 'Document forwarding & email notifications'],
    incEs: ['Dirección oficial en FL para correspondencia legal y estatal', 'Acepta notificaciones y documentos legales', 'Reenvío de documentos y notificación por correo'] },
  ...
  'sales-tax-registration': { icon: 'trending-up', subEn: 'One-time fee', subEs: 'Pago único',
    ...
    incEn: ['FL Department of Revenue registration', 'Sales tax certificate (DR-11)', 'Required for businesses selling taxable goods'],
    incEs: ['Registro con el Departamento de Ingresos de FL', 'Certificado de impuesto sobre ventas (DR-11)', 'Requerido para negocios que venden bienes gravables'] },
  ...
  'good-standing': { icon: 'award', subEn: '+ $9 FL state fee', subEs: '+ $9 de tarifa estatal de FL',
    ...
    incEn: ['Official certificate from FL Division of Corps', 'Certified digital & physical copy', 'Accepted by banks, investors & agencies'],
    incEs: ['Certificado oficial de la División de Corporaciones FL', 'Copia digital y física certificada', 'Aceptado por bancos, inversionistas y agencias'] },
  'scorp-election': { icon: 'star', subEn: 'One-time fee', subEs: 'Pago único',
    ...
    incEn: ['IRS Form 2553 preparation & submission', 'IRS acceptance confirmation letter', 'Only for U.S. citizens & permanent residents'],
    incEs: ['Preparación y envío del Formulario 2553 del IRS', 'Carta de aceptación del IRS', 'Solo para ciudadanos y residentes permanentes de USA'] },
  'foreign-llc': { icon: 'globe-2', subEn: '+ state filing fee', subEs: '+ tarifa estatal de presentación',
    ...
    incEn: ['Foreign qualification filing in target state', 'Certificate of Authority from FL Division of Corps', 'Registered Agent in target state available as an add-on', 'Available for all 50 U.S. states'],
    incEs: ['Calificación como Entidad Extranjera en el estado destino', 'Certificado de Autoridad de la División de Corporaciones FL', 'Agente Registrado en el estado destino disponible como adicional', 'Disponible para los 50 estados de USA'] },
  ...
  'cierre-fiscal': { icon: 'lock', subEn: 'One-time fee', subEs: 'Pago único',
    ...
    incEn: ['IRS EIN account closure letter preparation', 'FL Department of Revenue account closure', 'Verification your accounts are properly closed', 'Confirmation documents delivered by email'],
    incEs: ['Preparación de carta de cierre de cuenta EIN con el IRS', 'Cierre de cuenta con el Departamento de Ingresos de FL', 'Verificación de que tus cuentas quedan correctamente cerradas', 'Documentos de confirmación entregados por correo'] },
