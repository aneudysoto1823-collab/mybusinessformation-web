...
<div class="page-layout">
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a href="#name-availability">14. <span class="en-inline">Name Availability Check</span><span class="es-inline" style="display:none">Verificaci&oacute;n de Nombre</span></a>
      <a href="#assignment">15. <span class="en-inline">Assignment</span><span class="es-inline" style="display:none">Cesi&oacute;n</span></a>
    </nav>
  </aside>
  ...
  <div class="doc-content">
    ...
    <div class="doc-section" id="fees">
      ...
      <p class="en">Our service fees are clearly displayed during the order process. Current pricing: Basic $39, Standard $199, Premium $299 (plus applicable Florida state filing fees). Add-on service fees vary and are disclosed at the time of selection.</p>
      <p class="es" style="display:none">Nuestras tarifas de servicio se muestran claramente durante el proceso de pedido. Precios actuales: Basic $39, Standard $199, Premium $299 (m&aacute;s las tarifas estatales de Florida que apliquen). Las tarifas de servicios adicionales var&iacute;an y se revelan al momento de la selecci&oacute;n.</p>
      ...
      <p class="en">Service fee refunds may be requested within 24 hours of order placement and before any filing has been initiated. Once documents have been prepared or submitted, no refund will be issued. All refund requests must be submitted in writing to <!--email_off--><a href="mailto:info@opabiz.com">info@opabiz.com</a><!--/email_off-->.</p>
      <p class="es" style="display:none">Los reembolsos de tarifas de servicio pueden solicitarse dentro de las 24 horas posteriores a la realizaci&oacute;n del pedido y antes de que se haya iniciado cualquier tr&aacute;mite. Una vez preparados o enviados los documentos, no se emitir&aacute;n reembolsos. Todas las solicitudes de reembolso deben enviarse por escrito a <!--email_off--><a href="mailto:info@opabiz.com">info@opabiz.com</a><!--/email_off-->.</p>
      <h3 class="en">4.4 Recurring &amp; Auto-Renewing Services</h3><h3 class="es" style="display:none">4.4 Servicios Recurrentes y de Renovaci&oacute;n Autom&aacute;tica</h3>
      <p class="en">Certain services are billed on a recurring basis and renew automatically until you cancel. These include, but are not limited to: <strong>Virtual Mailing Address</strong> (billed monthly), <strong>Registered Agent</strong> (billed annually), and <strong>Annual Report Filing</strong> (billed annually). The billing cycle for each recurring service is disclosed next to its price at checkout (for example, "/mo" or "/yr").</p>
      <p class="es" style="display:none">Ciertos servicios se cobran de forma recurrente y se renuevan autom&aacute;ticamente hasta que los canceles. Estos incluyen, entre otros: <strong>Direcci&oacute;n Postal Virtual</strong> (cobro mensual), <strong>Agente Registrado</strong> (cobro anual) y <strong>Presentaci&oacute;n del Reporte Anual</strong> (cobro anual). El ciclo de cobro de cada servicio recurrente se indica junto a su precio en el checkout (por ejemplo, "/mes" o "/a&ntilde;o").</p>
      <p class="en">Some recurring services include a free first period (for example, Registered Agent is free the first year). After the free period, the service renews automatically at the then-current rate until you cancel.</p>
      <p class="es" style="display:none">Algunos servicios recurrentes incluyen un primer per&iacute;odo gratis (por ejemplo, el Agente Registrado es gratis el primer a&ntilde;o). Despu&eacute;s del per&iacute;odo gratis, el servicio se renueva autom&aacute;ticamente a la tarifa vigente hasta que canceles.</p>
      <p class="en">By purchasing a recurring service you authorize Florida Business Formation Center (OpaBiz) to charge your payment method automatically at the start of each billing cycle, at the then-current rate, until you cancel. You may cancel at any time from your client account, or by contacting <!--email_off--><a href="mailto:info@opabiz.com">info@opabiz.com</a><!--/email_off-->, before the next renewal date; cancellation stops future charges but does not refund fees already billed for the current cycle. We may change recurring fees with reasonable advance notice, which will apply to subsequent billing cycles.</p>
      <p class="es" style="display:none">Al comprar un servicio recurrente autorizas a Florida Business Formation Center (OpaBiz) a cobrar tu m&eacute;todo de pago autom&aacute;ticamente al inicio de cada ciclo de cobro, a la tarifa vigente, hasta que canceles. Puedes cancelar en cualquier momento desde tu cuenta de cliente, o escribiendo a <!--email_off--><a href="mailto:info@opabiz.com">info@opabiz.com</a><!--/email_off-->, antes de la siguiente fecha de renovaci&oacute;n; la cancelaci&oacute;n detiene los cobros futuros pero no reembolsa las tarifas ya cobradas del ciclo en curso. Podemos modificar las tarifas recurrentes con un aviso anticipado razonable, que aplicar&aacute; a los ciclos de cobro siguientes.</p>
    </div>
    ...
    <div class="doc-section" id="processing">
      ...
      <p class="en">For purposes of these Terms, a &ldquo;business day&rdquo; means Monday through Friday, excluding weekends and official Florida state holidays. Any estimate, notice, or automated status update referencing business days is calculated accordingly. For example, an order placed on a Friday, on a weekend, or on a state holiday is treated as received on the next business day for scheduling purposes.</p>
      <p class="es" style="display:none">Para efectos de estos T&eacute;rminos, un &ldquo;d&iacute;a h&aacute;bil&rdquo; significa de lunes a viernes, excluyendo fines de semana y los feriados oficiales del Estado de Florida. Cualquier estimado, aviso o actualizaci&oacute;n autom&aacute;tica de estado que haga referencia a d&iacute;as h&aacute;biles se calcula en consecuencia. Por ejemplo, una orden realizada un viernes, un fin de semana o un feriado estatal se considera recibida el siguiente d&iacute;a h&aacute;bil para efectos de programaci&oacute;n.</p>
      <p class="en">If your filing takes longer than the estimated timeframe above, please note that once we have submitted your filing to the Florida Division of Corporations (or the IRS, for EIN and ITIN services), our service fee is non-refundable under Section 4.3, because our portion of the work has already been completed. The estimated timeframe reflects that agency&rsquo;s typical turnaround, which we do not control and cannot guarantee.</p>
      <p class="es" style="display:none">Si su tr&aacute;mite tarda m&aacute;s del plazo estimado indicado arriba, tenga en cuenta que una vez que hayamos presentado su solicitud ante la Divisi&oacute;n de Corporaciones de Florida (o el IRS, para los servicios de EIN e ITIN), nuestra tarifa de servicio no es reembolsable seg&uacute;n la Secci&oacute;n 4.3, ya que nuestra parte del trabajo ya fue completada. El plazo estimado refleja el tiempo t&iacute;pico de respuesta de esa agencia, que no controlamos ni podemos garantizar.</p>
    </div>
    ...
    <div class="doc-section" id="name-availability">
      <h2>14. <span class="en-inline">Preliminary Business Name Availability Check</span><span class="es-inline" style="display:none">Verificaci&oacute;n Preliminar de Disponibilidad del Nombre Comercial</span></h2>
      <p class="en">When you enter your proposed business name during checkout, we may perform an automated preliminary search against the publicly available Florida Division of Corporations (Sunbiz) records to indicate whether the name appears to be already in use. <strong>This preliminary check is provided as a courtesy for your convenience and is not a guarantee of name approval, availability, or registrability.</strong> The final determination of whether a business name may be registered in Florida rests exclusively with the Florida Division of Corporations and is governed by Florida Statutes &sect;605.0112 (LLCs) and &sect;607.0401 (Corporations), as well as any applicable rules, policies, and discretionary determinations of the Division.</p>
      <p class="en">A name reported by our system as &ldquo;available&rdquo; may still be rejected by the Florida Division of Corporations for reasons that are not reflected in the public Sunbiz database we consult, including but not limited to: (a) names recently reserved by another party (reservations are valid for 120 days and may not appear in public records during processing); (b) names that include restricted terms requiring additional licensing or authorization (such as &ldquo;Bank,&rdquo; &ldquo;Trust,&rdquo; &ldquo;Insurance,&rdquo; &ldquo;Doctor,&rdquo; &ldquo;Engineering&rdquo;); (c) names that are deceptively similar to existing entities at the discretion of the reviewing examiner; (d) names that conflict with federally registered trademarks or service marks; (e) names containing words or characters prohibited by Florida statute; or (f) any other ground identified by the Florida Division of Corporations during the review of your filing.</p>
      <p class="en">If your business name is rejected by the Florida Division of Corporations after we have submitted your filing, we will contact you to request an alternative name and will resubmit the filing at no additional service fee from us. <strong>However, any additional or new state filing fees charged by the Florida Division of Corporations as a result of the resubmission are your sole responsibility.</strong> Original state filing fees already paid to the Florida Division of Corporations are non-refundable by us, as they are paid directly to the State and are outside our control. By proceeding with checkout, you acknowledge that you understand the preliminary nature of our name check and accept the conditions described in this section.</p>

      <p class="es" style="display:none">Cuando usted ingresa su nombre comercial propuesto durante el proceso de pago, podemos realizar una b&uacute;squeda preliminar automatizada en los registros p&uacute;blicos de la Divisi&oacute;n de Corporaciones de Florida (Sunbiz) para indicar si el nombre parece estar ya en uso. <strong>Esta verificaci&oacute;n preliminar se ofrece como una cortes&iacute;a para su conveniencia y no constituye una garant&iacute;a de aprobaci&oacute;n, disponibilidad o registrabilidad del nombre.</strong> La determinaci&oacute;n final sobre si un nombre comercial puede registrarse en Florida corresponde exclusivamente a la Divisi&oacute;n de Corporaciones de Florida y se rige por los Estatutos de Florida &sect;605.0112 (LLC) y &sect;607.0401 (Corporaciones), as&iacute; como por las reglas, pol&iacute;ticas y determinaciones discrecionales aplicables de la Divisi&oacute;n.</p>
      <p class="es" style="display:none">Un nombre que nuestro sistema reporte como &ldquo;disponible&rdquo; a&uacute;n podr&iacute;a ser rechazado por la Divisi&oacute;n de Corporaciones de Florida por razones que no se reflejan en la base de datos p&uacute;blica de Sunbiz que consultamos, incluyendo pero no limitado a: (a) nombres recientemente reservados por otra parte (las reservas son v&aacute;lidas por 120 d&iacute;as y pueden no aparecer en registros p&uacute;blicos durante el procesamiento); (b) nombres que incluyen t&eacute;rminos restringidos que requieren licencias o autorizaciones adicionales (como &ldquo;Banco,&rdquo; &ldquo;Trust,&rdquo; &ldquo;Insurance,&rdquo; &ldquo;Doctor,&rdquo; &ldquo;Engineering&rdquo;); (c) nombres que sean enga&ntilde;osamente similares a entidades existentes a discreci&oacute;n del examinador revisor; (d) nombres que entren en conflicto con marcas registradas o marcas de servicio federales; (e) nombres que contengan palabras o caracteres prohibidos por estatuto de Florida; o (f) cualquier otro motivo identificado por la Divisi&oacute;n de Corporaciones de Florida durante la revisi&oacute;n de su presentaci&oacute;n.</p>
      <p class="es" style="display:none">Si su nombre comercial es rechazado por la Divisi&oacute;n de Corporaciones de Florida despu&eacute;s de que hayamos presentado su tr&aacute;mite, lo contactaremos para solicitar un nombre alternativo y reenviaremos la presentaci&oacute;n sin cargo de servicio adicional de nuestra parte. <strong>No obstante, cualquier tarifa estatal adicional o nueva cobrada por la Divisi&oacute;n de Corporaciones de Florida como resultado del reenv&iacute;o ser&aacute; de su exclusiva responsabilidad.</strong> Las tarifas estatales originales ya pagadas a la Divisi&oacute;n de Corporaciones de Florida no son reembolsables por nuestra parte, ya que se pagan directamente al Estado y est&aacute;n fuera de nuestro control. Al proceder con el pago, usted reconoce que entiende la naturaleza preliminar de nuestra verificaci&oacute;n del nombre y acepta las condiciones descritas en esta secci&oacute;n.</p>
    </div>

    <div class="doc-section" id="assignment">
      <h2>15. <span class="en-inline">Assignment of Rights</span><span class="es-inline" style="display:none">Cesi&oacute;n de Derechos</span></h2>
